...
console.log(noise()); // for (let i = 0; i < 100; i += 0.01) {
...
canvas.height = innerHeight - 6; // Objects
...
for (var i = 0; i < 100; i++) {
  circles.push(new Circle(-30, -30, 10, "hsl(".concat(Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(0, 255), ",100%,50%)"), i * 0.01));
}

var time = 0; // Animation Loop
