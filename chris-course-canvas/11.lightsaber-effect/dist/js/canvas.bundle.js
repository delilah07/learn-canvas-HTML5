...
function init() {
  ...
  for (var i = 0; i < 200; i++) {
    var x = center.x + i * Math.cos(angle);
    var y = center.y + i * Math.sin(angle);
    particles.push(new Particle(x, y, 5, "hsl(".concat(hueColor, ",50%,50%)"), i));
    hueColor += 360 / 200;
  }
} // Animation Loop
