...
var increment = wave.frequence;

function animate() {
  requestAnimationFrame(animate);
  ctx.fillStyle = "rgba(".concat(backgroundColor.r, ",").concat(backgroundColor.g, ",").concat(backgroundColor.b, ",").concat(backgroundColor.a, ")");
  ...
  for (var i = 0; i < canvas.width; i++) {
    ctx.lineTo(i, wave.y + Math.sin(i * wave.length + increment) * wave.amplitude * Math.tan(increment));
  }

  ctx.strokeStyle = "hsl(".concat(Math.abs(strokeColor.h * Math.sin(increment)), ",").concat(strokeColor.s, "%,").concat(strokeColor.l, "%)");
  ctx.stroke();
