...
var colors = ['#990000', '#FF5B00', '#D4D925', '#FFEE63']; // Event Listeners
...
var Particle = /*#__PURE__*/function () {
  function Particle(x, y, radius, color) {
    ...
    this.velocity = 0.05;
    this.randomNum = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(50, 120);
    this.lastMouse = {
      x: x,
      y: y
    };
  ...
  _createClass(Particle, [{
    ...
    value: function update() {
      ...
      this.lastMouse.y += (mouse.y - this.lastMouse.y) * 0.05; //Drag effect
      //Circular Motion
...
function animate() {
  ...
  ctx.fillRect(0, 0, canvas.width, canvas.height); // ctx.fillText('HTML CANVAS BOILERPLATE', mouse.x, mouse.y);
