...
var colors = ['#2185C5', '#7ECEFD', '#e5ddce', '#FF7F66']; // Event Listeners
  ...
  _createClass(Circle, [{
    ...
    value: function update(particles) {
      ...
      for (var index = 0; index < particles.length; index++) {
        ...
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["distance"])(this.x, this.y, circleArr[index].x, circleArr[index].y) - this.radius * 2 < 0) {
          console.log('has');
          Object(_utils__WEBPACK_IMPORTED_MODULE_0__["resolveCollision"])(this, particles[index]);
        }
      }
      ...
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["distance"])(mouse.x, mouse.y, this.x, this.y) < 100 && this.opacity < 0.5) {
        this.opacity += 0.02;
  ...
  for (var index = 0; index < 400; index++) {
    ...
    if (index !== 0) {
      for (var j = 0; j < circleArr.length; j++) {
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["distance"])(x, y, circleArr[j].x, circleArr[j].y) - radius * 2 < 0) {
          x = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(radius, innerWidth - radius);
          y = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(radius, innerHeight - radius);
          j = -1;
        }
      }
    }
...
function animate() {
  ...
  circleArr.forEach(function (circle) {
    return circle.update(circleArr);
  });
}
